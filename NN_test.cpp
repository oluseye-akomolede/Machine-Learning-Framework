...
NN_test::NN_test()
{
	...
	lin_layer2 = new linear_layer(1500, 1500, true, false);
	act_layer2 = new activation_layer(1500, 1500, act_function_type::Hard_Tanh);
	lin_layer3 = new linear_layer(1500, 10, true, false);
